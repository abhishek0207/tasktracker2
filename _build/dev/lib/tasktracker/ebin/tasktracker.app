{application,tasktracker,
             [{applications,[kernel,stdlib,elixir,logger,runtime_tools,
              ...
              {modules,['Elixir.Tasktracker','Elixir.Tasktracker.Accounts',
                        ...
                        'Elixir.Tasktracker.Reports',
                        'Elixir.Tasktracker.Reports.Reportee',
                        'Elixir.Tasktracker.TaskHandler',
                        'Elixir.Tasktracker.TaskHandler.Task',
                        'Elixir.Tasktracker.TaskHandler.Timeblock',
                        ...
                        'Elixir.TasktrackerWeb.ReporteeController',
                        'Elixir.TasktrackerWeb.ReporteeView',
                        'Elixir.TasktrackerWeb.RepoteeView',
