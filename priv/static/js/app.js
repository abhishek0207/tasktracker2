...
$("#new_form_button").click(function (e) {
  var start_year = $("#newTimeblock_start_time_year").val();
  var start_month = $("#newTimeblock_start_time_month").val();
  var start_day = $("#newTimeblock_start_time_day").val();
  var start_hour = $("#newTimeblock_start_time_hour").val();
  var start_minute = $("#newTimeblock_start_time_minute").val();
  var end_year = $("#newTimeblock_end_time_year").val();
  var end_month = $("#newTimeblock_end_time_month").val();
  var end_day = $("#newTimeblock_end_time_day").val();
  var end_hour = $("#newTimeblock_end_time_hour").val();
  var end_minute = $("#newTimeblock_end_time_minute").val();
  var new_start_time = new Date(start_year, start_month, start_day, start_hour, start_minute);
  //let edit_start_time = start_year + "-" + start_month + "-" + start_day + " " + start_hour + ":" + start_minute + ":"+ "00" + "." + "000000"
  var new_end_time = new Date(end_year, end_month, end_day, end_hour, end_minute);
  //let edit_end_time = end_year + "-" + end_month + "-" + end_day + " " + end_hour + ":" + end_minute  + ":" + "00" + "." + "000000"
  var new_task_id = $("#editTaskid").val();
  var new_user_id = $("#edituserid").val();
  if (new_start_time > new_end_time) {
    ...
    $.ajax(timeBlockPath, {
      ...
      data: jsonStart,
      success: function success() {
        alert('Timeblock Added') ? "" : location.reload();
      }
    });
  }
});
